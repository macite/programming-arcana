...
\begin{itemize}
  ...
  \item \texttt{\textbf{sprintf}}: Same as \texttt{printf} (see \nameref{sub:c_console_output}), except that the output is stored in a c-string. Int his case the \csnipet{"\%2d"} ensures that only 2 characters (plus the terminator) are written into the string.
