...
\begin{itemize}
  ...
  \item \nameref{sub:compound_statements}: Group statements together.
  \item \nameref{sub:pre_test_loop}: Loop after testing a condition.
  \item \nameref{sub:post_test_loop}: Loop then test a condition.
\end{itemize}

In addition to these actions, you will need to understand some programming \textbf{terminology}. The following terms are discussed in this section:
\begin{itemize}
  \item \nameref{sub:boolean_data}: A \nameref{sub:type} that has either a \emph{true} or \emph{false} value.
\end{itemize}
...
\input{topics/control-flow/concepts/boolean}

\input{topics/control-flow/concepts/branching}
\input{topics/control-flow/concepts/if-statement}
\input{topics/control-flow/concepts/case-statement}

\input{topics/control-flow/concepts/looping}
\input{topics/control-flow/concepts/pre-test-loop}
\input{topics/control-flow/concepts/post-test-loop}

\input{topics/control-flow/concepts/jump-statements}
\input{topics/control-flow/concepts/break}
\input{topics/control-flow/concepts/continue}
\input{topics/control-flow/concepts/exit}
\input{topics/control-flow/concepts/goto}


\input{topics/control-flow/concepts/combining-statements}
\input{topics/control-flow/concepts/statement-with-loops}
...
\input{topics/control-flow/exercises/exercises}
